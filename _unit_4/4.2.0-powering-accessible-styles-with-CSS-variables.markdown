...
<div>
<a href="https://twitter.com/intent/tweet?screen_name=mrktps" class="twitter-mention-button" data-size="large" data-text="Just turned in my Intro to Web Architecture CSS Variables assignment!" data-show-count="false">Tweet to @mrktps</a><script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
</div>
</aside>
{% endcomment %}
